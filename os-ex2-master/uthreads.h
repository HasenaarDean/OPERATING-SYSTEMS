...
#define ID_OF_MAIN_THREAD 0
#define ERROR_RETURN_VALUE -1
#define SUCCESS_RETURN_VALUE 0
#define BLOCK true
#define UNBLOCK false
#define UNBLOCK_SIGNALS_ERR_MSG "system error: there was a problem with unblocking the signals \n"
#define BLOCK_SIGNALS_ERR_MSG "system error: there was a problem with blocking the signals \n"

/* External interface */

sigset_t setOfSignalsToBlock;
ThreadManager* threadsList[MAX_THREAD_NUM] = {nullptr};
...
/**
 * This function clears all memory allocations we used.
 */
